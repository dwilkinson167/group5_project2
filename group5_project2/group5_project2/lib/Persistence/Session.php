...
include '/lib/Persistence/Interface.php';

class Persistence_Session implements Persistence_Interface
{
	/**
	 * Default namespace
	 * @var string
	 */
	protected $_namespaceDefault = 'default_persistence';
